...
public class MonoFilterSlideWindow extends PlatformWindow implements OnHoverListener{
	...
	int mDuration = 100;
	public MonoFilterSlideWindow(Context context) {
		super(context);
		setHovered(true);
	...
	protected void buildSlideTree() {
		...
		mSpotSlide.setFilterType(SVISlide.FilterType.FILTER_MONOTONE);
