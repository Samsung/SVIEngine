...
public class ImplicitAnimation_One_Activity extends Activity implements OnTouchListener{
	...
	private void setImplicitAnimation(){
		...
		mSubSlide.setPosition(new SVPoint(500.0f, 500.0f), duration);
		mSubSlide.setBorderWidth(100.0f, duration);
