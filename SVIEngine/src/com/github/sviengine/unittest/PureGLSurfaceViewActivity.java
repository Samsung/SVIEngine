...
public class PureGLSurfaceViewActivity extends Activity{
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		*/
		mGLView.setEGLContextFactory(new ContextFactory());
		...
		* below.
		*/
		//ToDo : Fix ConfigChooser function because, if enable below function, app is died. 
		mGLView.setEGLConfigChooser(translucent ?
