...
public class PageTwistEffectWindow extends PlatformWindow implements SVIAnimationListener{
	
	public static final String TAG = "PageTurnEffectWindow";
	
	public PageTwistEffectWindow(Context context){
		super(context);
	...
	protected void buildSlideTree(){
		...
		mPageSlide.setDeformType(SlideDeformType.DEFORM_TWIST);	
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (item.getTitle() == "Reverse Twist"){
		...
		}else if (item.getTitle() == "Twist Vertical / Horizon"){
