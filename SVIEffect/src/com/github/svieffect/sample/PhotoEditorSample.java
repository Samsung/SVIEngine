...
import com.github.svieffect.copyandpaste.SVICopyAndPasteView;

//NOTE GRAPHICS: 
//should implements from SGIEffectListener interface for to check first render finished.
public class PhotoEditorSample extends Activity implements SVICopyAndPasteCallback{
	
	public static SVICopyAndPasteView mCopyAndPasteView = null;
	...
	public void buildViews(){
		...
		mCopyAndPasteView = new SVICopyAndPasteView(this);
