...
import com.github.visualview.animation.SVAnimationSet;
import com.github.visualview.animation.SVBasicAnimation;
import com.github.visualview.animation.SVKeyFrameAnimation;

public class AnimationSetActivity extends Activity implements OnTouchListener{
	...
	private void setAnimationSet(){
		...
		aniSet.setInterpolator(SV.INTERPOLATOR_ACCELERATE_DECELERATE);
		
		SVBasicAnimation posAni = new SVBasicAnimation(SVAnimation.POSITION, new float[]{300.0f, 300.0f}, new float[]{500.0f, 700.0f});
